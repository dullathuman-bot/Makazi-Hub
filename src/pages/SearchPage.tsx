                ...
                <div>
                  ...
                  <button
                    ...
                    className={`glass flex w-full items-center justify-between rounded-xl px-3 py-2.5 text-sm transition-all ${
                      availableOnly ? 'text-sand ring-1 ring-sand/30' : 'text-sand/60'
                    }`}
                  >
    ...
    >
      ...
      >
        ...
        <div className="px-2.5 pb-2.5">
          <button className="glass-button w-full rounded-xl py-2 text-[10px] font-medium text-sand transition-all hover:text-white sm:text-xs">
            View Details
          </button>
        </div>
      </GlassCard>
